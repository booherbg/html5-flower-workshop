...
function drawFlower(startX, startY, number, color, size) {
   // color = 'blue';
   border = 'white';
   ...
   requestAnimationFrame(() => drawFlower(startX, startY, number += 1, color+.1, size));
}
...
function getRelativeCoords(event) {
   ...
   drawFlower(x, y, 0, Math.random()*300, 30);
